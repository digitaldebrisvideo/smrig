...
# def timer(func):
# 	"""
# 	The timer decorator will print the full name of the function and the
# 	duration of the execution of that function.
# 	"""
...
# 		t_end = time.time()
# 		log.info(f"{full_name} executed in {t_end - t_start:.3f} seconds")
# 		return result
