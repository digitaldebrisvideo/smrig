...
from smrig.gui.tool import modelsettings, guidebuild , guideloader, dataimporter, dataexporter
...
class CharMain(QtWidgets.QDialog):
	...
	def __init__(self, parent=maya_main_window):
		...
		# guide build tab -----------------------------------------
		self.guide_wdg = guidebuild.GuideBuild(self)
		self.tabs.addTab(self.guide_wdg, "SM Guide Build")
		...
		self.tabs.addTab(self.dataload_wdg, "Data Import")

		# data export tab -----------------------------------------
		self.datasave_wdg = dataexporter.DataExporter (self)
		self.tabs.addTab (self.datasave_wdg ,  "Data Export")
	...
	def reload_ui(self):
		...
		self.datasave_wdg.reload_ui()
		self.dataload_wdg.reload_ui()
		self.gui_wdg.reload_ui()
