...
from smrig.dataio.utils import remap_file
...
class DataLoader(QtWidgets.QDialog):
	file_path = None
	node_items = []
	...
	def load_file(self):
		...
		:return:
		"""
		file_path = dataio.utils.browser(extension="*", dir=env.asset.get_data_path())

		if not file_path:
			return

		self.file_path = file_path
		required_nodes = dataio.get_required_nodes(self.file_path)
		required_nodes.sort()
	...
	def load_data(self):
		...
		dataio.load(self.file_path, method=method, remap=remap)
