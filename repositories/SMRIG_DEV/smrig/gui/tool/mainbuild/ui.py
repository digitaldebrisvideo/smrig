...
from smrig.gui.tool import guidebuild
from smrig.gui.tool import rigbuild
from smrig.gui.tool import dataexporter
from smrig.gui.tool import dataloader
from smrig.gui.tool import toolbox
...
class MainBuild(QtWidgets.QDialog):

    def __init__(self, parent=maya_main_window):
        super(MainBuild, self).__init__(parent)

        # Parent widget under Maya mainbuild window
        self.setParent(parent)
        self.setWindowTitle("SMRIG Rig")
        ...
        self.m_header = header.Header(self, large=True, logo=True, title="SMRIG Rig")
        ...
        # guide build tab -----------------------------------------
        self.dataexport_wdg = dataexporter.DataExporter(self)
        self.tabs.addTab(self.dataexport_wdg, "Export Data")

        # guide build tab -----------------------------------------
        self.dataload_wdg = dataloader.DataLoader(self)
        ...
        self.settings = QtCore.QSettings("Saavedra_Studio", "Rig_Bot")
