...
class RigBuild(QtWidgets.QWidget):
	stored_build_list = []
	...
	def __init__(self, parent=mayawin.maya_main_window):
		super(RigBuild, self).__init__(parent)
		...
		self.header = header.Header(self, large=False, light_grey=True, title="Rig Build Steps", info_icon="edit.png")
		self.header.help_button.setCheckable(True)
		self.header.help_button.toggled.connect(self.toggle_build_list_edit)

		# self.menu = QtWidgets.QMenuBar(self)
		# self.menu.setMaximumWidth(60)

		# Model Path ----------------------------------------------

		# model_path_wdg = QtWidgets.QFrame(self)
		# model_path_layout = QtWidgets.QHBoxLayout(model_path_wdg)
		# model_path_label = QtWidgets.QLabel("Build List: ")
		# self.model_path_line = QtWidgets.QLineEdit(self)
		# self.model_path_line.setFocusPolicy(QtCore.Qt.NoFocus)
		# self.model_path_line.setReadOnly(True)
		#
		# # model_path_layout.addWidget(self.menu)
		...
		# model_path_wdg.setStyleSheet("QFrame{background-color: rgb(58, 58, 58)}")
		...
		#
		# action = QAction(self)
		# action.setText("Set Models To Load")
		# action.triggered.connect(self.launch_model_loader)
		# self.file_menu.addAction(action)
		...
		# layout.addWidget(self.menu, 1, 0, 1, 2)
