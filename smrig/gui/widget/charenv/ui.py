...
class CharEnv(QtWidgets.QFrame):
	post_function = None

	def __init__(self, parent=maya_main_window):
		super(CharEnv, self).__init__(parent)
		...
		layout.addWidget(variant_label, 1, 0)
		layout.addWidget(self.variant_cmb, 1, 1)
		layout.addWidget(self.inheritance_btn, 1, 2)
		layout.addWidget(build_path_label, 2, 0)
		layout.addWidget(self.build_path_line, 2, 1, 1, 5)
		layout.addWidget(self.build_path_btn, 2, 6)
		layout.addWidget(data_path_label, 3, 0)
		layout.addWidget(self.data_path_line, 3, 1, 1, 5)
		layout.addWidget(self.data_path_btn, 3, 6)
		...
		self.build_path_line.hide()
		self.build_path_btn.hide()
		build_path_label.hide()
