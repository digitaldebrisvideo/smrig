...
from smrig.build import model, mh
...
log = logging.getLogger("smrig.gui.widget.modelsettings")


class ModelSettings(QtWidgets.QDialog):
	...
	def __init__(self, parent=maya_main_window):
		...
		self.g_header = header.Header(self, large=False, title="Set LookDev File Path")
		...
		self.add_button = QtWidgets.QPushButton("Set Model File Path")
		...
		# self.prep_button = QtWidgets.QPushButton("Prep Model \n[Run once, unless shape of model changes]")
		# self.prep_button.released.connect(self.prep)
		...
		# layout.addWidget(self.prep_button, 4 , 0,  1, 2)
	...
	def prep(self):
		...
		mh.migrate_mh_rig()
		mh.match_mh_mesh_to_custom_mesh()
		print("DONE MIGRATING MH FROM BASE RIG")
